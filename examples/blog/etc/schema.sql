...
--
-- Definition of table `blog`.`Article`
--
...
--
-- Dumping data for table `blog`.`Category`
--
INSERT INTO `blog`.`Category` (`id`,`label`,`term`,`scheme`) VALUES 
 (1,'Art','art','http://www.nitroframework.org'),
 (2,'Life','life','http://www.nitroframework.org'),
 (3,'Technology','technology','http://www.nitroframework.org'),
 (4,'Business','business','http://www.nitroframework.org'),
 (5,'Dogma','dogma','http://www.nitroframework.org');
...
CREATE TABLE  `blog`.`Comment` (
  ...
  `authorURI` varchar(128) default NULL,
...
--
INSERT INTO `blog`.`Comment` (`id`,`parentId`,`authorName`,`authorEmail`,`authorURI`,`content`,`created`) VALUES 
 (32,10,'fasdfasfsd','fasdfdsafasd','fasdfa fasdf','fasdfsdafasd','2009-03-15 11:01:37'),
 (33,10,'George Moschovitis','george.moschovitis@gmail.com','http://www.me.gr','This is a nice little comment ;-)','2009-03-15 11:02:04');

--
-- Definition of table `blog`.`Tag`
--
...
--
-- Dumping data for table `blog`.`Tag`
--
INSERT INTO `blog`.`Tag` (`id`,`name`,`count`) VALUES 
 (1,'dogma',4),
 (2,'SF',1),
 (3,'Apple',1),
 (4,'design',1),
...
--
-- Definition of table `blog`.`TagToArticle`
--

DROP TABLE IF EXISTS `blog`.`TagToArticle`;
CREATE TABLE  `blog`.`TagToArticle` (
...
--
-- Dumping data for table `blog`.`TagToArticle`
--
INSERT INTO `blog`.`TagToArticle` (`parentId`,`tagId`) VALUES 
 (1,1),
 (1,2),
 (2,3),
 (2,4),
